<template>
    ...
    <TextfieldForms :label="`Nombre Subformulacion - Seccion`"  :name="`name_sfrm`" :onChange="setValues"/>
    </v-col>    
    <v-col cols="3" xs="12" sm="6"  md="4" lg="3" xl="3">
...
import QuestionAnswerForm from './QuestionAnswerForm.vue';
  ...
  export default {
    name:"",
      components: { TextfieldForms, BtnNewForms, ListBoxForms, CheckForms, QuestionAnswerForm },
